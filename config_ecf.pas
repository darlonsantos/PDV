...
uses
  ...
  Dialogs, ExtCtrls, StdCtrls, ComCtrls, RXClock, Buttons, Mask,
  Menus, AdvMenus, XPMan, RxToolEdit, RxCurrEdit;
...
begin
  ...
  1 : begin
        ...
        begin
          application.messagebox(pwidechar('Comando não executado!'+#13+
