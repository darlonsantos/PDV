...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, Mask, XPMan, RxToolEdit;
  ...
  begin
    ...
    begin
      ...
      begin
         ...
         begin
           sNome_Arquivo := 'c:\Athenas\pdv\txt\Espelho_MFD.txt';
         ...
         begin
           application.messagebox(pwidechar('Arquivo não encontrado!'+#13+
